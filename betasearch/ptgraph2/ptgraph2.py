...
# Created: July 2007
#
# $Id: ptgraph2.py,v 5bbae4254475 2012/05/05 06:48:47 hohkhkh1 $
#
...
class PTGraph2:
    ...
    def __init__(self, pdb_structure, secstruct, use_hbonds=False,
...
#            print 'rrr',chainid,domain_min_resnum,domain_max_resnum
    ...
    def build_sheet_constraints(self, ptnode_list):
        ...
        if num_cycles > 0:
            ...
            sys.stderr.write("detected " + str(num_cycles) +
                             " beta barrel(s)\n")
            for (open_node1, open_node2) in self.sheet_backedges_dict[sheet_id]:
                sys.stderr.write("opened barrel by removing bridge from " +
...
def make_graphs(pdb_filename,
    ...
    Paramteters:
      ...
      label_residue_numbers - if True put start and end residue ids
                            on head and tail of helix shape
       betapy_mode - set to True to bypass distance matrix/dunnart calculation.
    ...
    for domain in domain_list:
        ptg = PTGraph2(pdb_struct, secstruct, use_hbonds,
