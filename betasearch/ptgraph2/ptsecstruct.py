...
# Created: July 2007
#
# $Id: ptsecstruct.py,v aaa41425b242 2012/07/06 04:54:39 hohkhkh1 $
#
...
def read_secstruct_from_dssp(pdb_filename, pdb_secstruct = None):
    ...
    fd = os.popen("dsspcmbi " + pdb_filename + " 2> /dev/null")
...
#                        print 'yyy START',dssp_code, pdb_resnum
            ...
            if dssp_code == 'E': # only use bridge partners from E not B
                ...
                # The following two try-except blocks check if bridge partner
                # residue numbers are not numbers e.g. this occurs on 1htq where
                # some bp resnums are "***".
                try:
